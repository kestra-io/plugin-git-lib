...
/**
 * Shared base for integration tests that need a real, running Kestra instance (Sync/Push tasks talking to the
 * Kestra API over HTTP rather than an in-process mock).
 */
@Testcontainers
