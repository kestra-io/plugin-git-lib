 ...
 * the credentials.
 */
public final class KestraApiConnection {
    ...
    public Optional<SDK.Auth> defaultAuth() {
     ...
     */
    public static KestraApiConnection resolve(RunContext runContext, @Nullable Property<String> kestraUrl, @Nullable KestraApiAuth auth) throws IllegalVariableEvaluationException {
