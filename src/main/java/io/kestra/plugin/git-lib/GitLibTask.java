package io.kestra.plugin.git-lib;
    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.git-lib.GitLibTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class GitLibTask extends Task implements RunnableTask<GitLibTask.Output> {
    @Schema(
    ...
    @Override
    public GitLibTask.Output run(RunContext runContext) throws Exception {
